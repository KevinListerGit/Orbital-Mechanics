...
if __name__ == '__main__':
    ...
    conn_str = (
        r'DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};'r'DBQ=C:\Users\kevin\OneDrive\game theory analysis\orbital_mechanics.accdb;')
    ...
    if EnterDataOrSelectFromDatabase == "Yes":
        ...
        for counter in range (number_of_bodies):
            ...
            Objectstring = data_entry(BodyName) #sets objectstring as an object of the data_entry class
            Objectstring.bodydata()  # calls the function bodydata
